...
$(document).ready(function () {
    // Metodo usado para iniciar la busqueda a través de la API
    $("#form").submit(function (e) {

        e.preventDefault();
        const sp_number = $("#sp_number");
        const idSH = sp_number.val() //Valor utilizado para determinar que carácter se mostrará.
        ...
        if (idSH == stringValidation || idSH > 731 || idSH < 1) {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: `https://superheroapi.com/api.php/10225865940492837/${idSH}`, //URL que se usara para recuperar la matriz.
